...
<html lang="en">
    ...
    <head>
        ...
        <title>Reset Password | Mgote Physics</title>
    </head>
    ...
    <body>
        ...
        <div class="d-flex justify-content-center align-items-center flex-column">
            <h2 class="text-primary my-2 mt-5">Create New Password</h2>
            ...
            ?>
                ...
                <form action="login.php" method="POST">
                    <div class="form-group my-3">
                        ...
                        <span class="text-danger"><?php echo $resetPasswordError ?></span>
                    </div>
                    <div class="form-group my-3">
                        <label for="" class="form-label">Confirm Password</label>
                        <input type="password" id="resetConfirmPassword" name="resetConfirmPassword"
                            class="form-control" placeholder="Enter Password">
                        <span class="text-danger"><?php echo $resetPasswordError ?></span>
                    </div>
                    <button class="btn btn-primary w-100" name="updatePassword">Update Password</button>
                </form>
            </div>
        </div>
    </body>
